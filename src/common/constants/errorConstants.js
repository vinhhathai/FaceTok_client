...
export const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.AUTH.EMAIL_NOT_VERIFIED]: 'Email chưa được xác thực. Vui lòng kiểm tra email và nhập mã OTP.',
  ...
  [ERROR_CODES.AUTH.VERIFY_EMAIL_FAILED]: 'Xác thực email thất bại.',
  [ERROR_CODES.AUTH.RESEND_OTP_FAILED]: 'Gửi lại mã OTP thất bại.',
